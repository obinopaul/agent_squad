...
import FlashCard, { FlashCardData } from "./flash-card";
    ...
    <AnimatePresence>
      {isVisible && currentCard && (
        <motion.div
          ...
          className="fixed right-8 top-1/4 w-80 bg-gray-900 p-4 rounded-lg shadow-lg z-50"
        >
          ...
          {flashCards.length > 1 && (
            <div className="flex justify-between mt-4 items-center">
              ...
              <span className="text-white">{(currentCardIndex ?? 0) + 1} / {flashCards.length}</span>
              <button
                onClick={() => setCurrentCardIndex(prev => 
