    ...
    <AnimatePresence>
      {isVisible && currentQuestion && (
        <motion.div
          ...
          className="fixed left-8 top-1/4 w-80 bg-gray-900 p-4 rounded-lg shadow-lg z-50"
        >
          ...
          <div className="flex justify-between mt-4 items-center">
            ...
            <span className="text-white">{(currentQuestionIndex ?? 0) + 1} / {questions.length}</span>
            {!isLastQuestion ? (
              <button
                onClick={() => setCurrentQuestionIndex(prev => 
              ...
              <button
                ...
                className="px-3 py-1 bg-green-600 rounded disabled:opacity-50 text-white"
              >
                Submit Quiz
              </button>
            )}
