...
from supervisoragents.agent_name import AgentNameMode, with_agent_name
from supervisoragents.handoff import (
...
def create_supervisor(
    ...
    *,
    ...
    add_handoff_messages: bool = True,      # Whether to add handoff messages from the subagents state so that the assigned agents doesn’t have to view the supervisor’s routing logic
